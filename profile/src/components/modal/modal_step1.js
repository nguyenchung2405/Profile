...
export default function Modal_step1(props) {
  let {
    ...
    setValidateForm,
    validateForm,
    getValueSelect_NoiSinh_Tinh_TP,
    getValueSelect_NoiSinh_Quan_TP,
    renderTinh,
    getValueSelect_NoiSinh_Huyen,
    renderQuan,
    renderHuyen,
    showRequiredAlert,
    getValueSelect_QueQuan_Tinh_TP,
    getValueSelect_QueQuan_Quan_TP,
    getValueSelect_QueQuan_Huyen,
    disabledInput,
    setValueForm,
  } = props;
  const { Option } = Select;
  ...
  useEffect(() => {
    if (
      valueForm.queQuan.quan === "Không rõ" &&
      valueForm.queQuan.huyen === "Không rõ"
    )
      setChecked(true);
  }, [valueForm.queQuan]);
  const onChangeCheckbox = (e) => {
    if (e?.target?.checked === true) {
      ...
      let queQuanNew = { ...queQuan, quan: "Không rõ", huyen: "Không rõ" };
      setValueForm({
        ...valueForm,
        queQuan: { ...queQuanNew },
      });
      ...
      return (
        <div className="SYLL__left__field noiSinh">
          <Select
            ...
            value={valueForm.noiSinh.tinh !== "" ? valueForm.noiSinh.tinh : ""}
            onBlur={() => {
              if (valueForm.noiSinh.tinh === "") {
                setValidateForm({
                  ...validateForm,
                  noiSinh: { ...validateForm.noiSinh, tinh: true },
                });
              } else {
                setValidateForm({
                  ...validateForm,
                  noiSinh: { ...validateForm.noiSinh, tinh: false },
                });
              }
            }}
          ...
          <Select
            ...
            disabled={disabledInput()}
            value={valueForm.noiSinh.quan !== "" ? valueForm.noiSinh.quan : ""}
            onBlur={() => {
              if (valueForm.noiSinh.quan === "") {
                setValidateForm({
                  ...validateForm,
                  noiSinh: { ...validateForm.noiSinh, quan: true },
                });
              } else {
                setValidateForm({
                  ...validateForm,
                  noiSinh: { ...validateForm.noiSinh, quan: false },
                });
              }
            }}
          ...
          <Select
            ...
            disabled={disabledInput()}
            value={
              valueForm.noiSinh.huyen !== "" ? valueForm.noiSinh.huyen : ""
            }
            onBlur={() => {
              if (valueForm.noiSinh.huyen === "") {
                setValidateForm({
                  ...validateForm,
                  noiSinh: { ...validateForm.noiSinh, huyen: true },
                });
              } else {
                setValidateForm({
                  ...validateForm,
                  noiSinh: { ...validateForm.noiSinh, huyen: false },
                });
              }
            }}
        ...
        return (
          <div className="SYLL__left__field queQuan">
            <Select
              ...
              disabled={disabledInput()}
              value={
                valueForm.queQuan.tinh !== "" ? valueForm.queQuan.tinh : ""
              }
              onBlur={() => {
                if (valueForm.queQuan.tinh === "") {
                  setValidateForm({
                    ...validateForm,
                    queQuan: { ...validateForm.queQuan, tinh: true },
                  });
                } else {
                  setValidateForm({
                    ...validateForm,
                    queQuan: { ...validateForm.queQuan, tinh: false },
                  });
                }
              }}
            ...
            <Select
              ...
              disabled={disabledInput()}
              value={
                valueForm.queQuan.quan !== "" ? valueForm.queQuan.quan : ""
              }
              onBlur={() => {
                if (valueForm.queQuan.quan === "") {
                  setValidateForm({
                    ...validateForm,
                    queQuan: { ...validateForm.queQuan, quan: true },
                  });
                } else {
                  setValidateForm({
                    ...validateForm,
                    queQuan: { ...validateForm.queQuan, quan: false },
                  });
                }
              }}
            ...
            <Select
              ...
              disabled={disabledInput()}
              value={
                valueForm.queQuan.huyen !== "" ? valueForm.queQuan.huyen : ""
              }
              onBlur={() => {
                if (valueForm.queQuan.huyen === "") {
                  setValidateForm({
                    ...validateForm,
                    queQuan: { ...validateForm.queQuan, huyen: true },
                  });
                } else {
                  setValidateForm({
                    ...validateForm,
                    queQuan: { ...validateForm.queQuan, huyen: false },
                  });
                }
              }}
            ...
            {/* {validateForm.queQuan?.huyen || validateForm.queQuan?.quan || validateForm.queQuan?.tinh
                        ? showRequiredAlert() 
                        : ""} */}
            <Checkbox onChange={onChangeCheckbox}>Không rõ</Checkbox>
          </div>
        );
