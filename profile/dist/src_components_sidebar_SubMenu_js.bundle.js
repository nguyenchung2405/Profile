...
function SubMenu(permission) {
  ...
  var renderSubMenu2 = function renderSubMenu2() {
    ...
    if ((0,_ultils_helper__WEBPACK_IMPORTED_MODULE_3__.checkMicroFe)() === true && getUserId() === true) {
      return items;
    }
    // Duoi local profile
    else {
